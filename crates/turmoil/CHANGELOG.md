...
## [0.8.0](https://github.com/tokio-rs/turmoil/compare/turmoil-v0.7.2...turmoil-v0.8.0) - 2026-07-21
...
- *(fs)* [**breaking**] simplify setup — Fs is now a handle, enter takes no context ([#284](https://github.com/tokio-rs/turmoil/pull/284))
